...
module my_nios1_mm_interconnect_0 (
	...
	wire  [102:0] rsp_mux_src_data;                                                                      // rsp_mux:src_data -> nios2_processor_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                     // nios2_processor_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [7:0] rsp_mux_src_channel;                                                                   // rsp_mux:src_channel -> nios2_processor_data_master_agent:rp_channel
	...
	wire  [102:0] rsp_mux_001_src_data;                                                                  // rsp_mux_001:src_data -> nios2_processor_instruction_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                                 // nios2_processor_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [7:0] rsp_mux_001_src_channel;                                                               // rsp_mux_001:src_channel -> nios2_processor_instruction_master_agent:rp_channel
	...
	wire  [102:0] cmd_mux_002_src_data;                                                                  // cmd_mux_002:src_data -> nios2_processor_debug_mem_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                                 // nios2_processor_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                               // cmd_mux_002:src_channel -> nios2_processor_debug_mem_slave_agent:cp_channel
	...
	wire  [102:0] cmd_mux_004_src_data;                                                                  // cmd_mux_004:src_data -> switches_s1_agent:cp_data
	...
	wire  [103:0] fifoed_avalon_uart_0_s1_agent_rf_source_data;                                          // fifoed_avalon_uart_0_s1_agent:rf_source_data -> fifoed_avalon_uart_0_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] fifoed_avalon_uart_0_s1_agent_rsp_fifo_out_data;                                       // fifoed_avalon_uart_0_s1_agent_rsp_fifo:out_data -> fifoed_avalon_uart_0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                                 // cmd_mux_007:src_valid -> fifoed_avalon_uart_0_s1_agent:cp_valid
	wire  [102:0] cmd_mux_007_src_data;                                                                  // cmd_mux_007:src_data -> fifoed_avalon_uart_0_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                                 // fifoed_avalon_uart_0_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                               // cmd_mux_007:src_channel -> fifoed_avalon_uart_0_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                         // cmd_mux_007:src_startofpacket -> fifoed_avalon_uart_0_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                           // cmd_mux_007:src_endofpacket -> fifoed_avalon_uart_0_s1_agent:cp_endofpacket
	...
	wire  [102:0] nios2_processor_debug_mem_slave_agent_rp_data;                                         // nios2_processor_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [102:0] switches_s1_agent_rp_data;                                                             // switches_s1_agent:rp_data -> router_006:sink_data
	...
	wire          fifoed_avalon_uart_0_s1_agent_rp_valid;                                                // fifoed_avalon_uart_0_s1_agent:rp_valid -> router_009:sink_valid
	wire  [102:0] fifoed_avalon_uart_0_s1_agent_rp_data;                                                 // fifoed_avalon_uart_0_s1_agent:rp_data -> router_009:sink_data
	wire          fifoed_avalon_uart_0_s1_agent_rp_ready;                                                // router_009:sink_ready -> fifoed_avalon_uart_0_s1_agent:rp_ready
	wire          fifoed_avalon_uart_0_s1_agent_rp_startofpacket;                                        // fifoed_avalon_uart_0_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          fifoed_avalon_uart_0_s1_agent_rp_endofpacket;                                          // fifoed_avalon_uart_0_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [102:0] cmd_demux_001_src2_data;                                                               // cmd_demux_001:src2_data -> cmd_mux_006:sink1_data
	...
	wire  [102:0] rsp_demux_006_src1_data;                                                               // rsp_demux_006:src1_data -> rsp_mux_001:sink2_data
	...
	wire          fifoed_avalon_uart_0_s1_agent_rdata_fifo_src_valid;                                    // fifoed_avalon_uart_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] fifoed_avalon_uart_0_s1_agent_rdata_fifo_src_data;                                     // fifoed_avalon_uart_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          fifoed_avalon_uart_0_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_007:in_0_ready -> fifoed_avalon_uart_0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                     // avalon_st_adapter_007:out_0_valid -> fifoed_avalon_uart_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                      // avalon_st_adapter_007:out_0_data -> fifoed_avalon_uart_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                     // fifoed_avalon_uart_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                     // avalon_st_adapter_007:out_0_error -> fifoed_avalon_uart_0_s1_agent:rdata_fifo_sink_error
	...
	my_nios1_mm_interconnect_0_router_002 router_007 (
	...
	my_nios1_mm_interconnect_0_router_008 router_008 (
	...
	my_nios1_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clocks_sys_clk_clk),                                //       clk.clk
		.reset               (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_nios1_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (clocks_sys_clk_clk),                                //       clk.clk
		.reset               (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_nios1_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clocks_sys_clk_clk),                                //       clk.clk
		.reset              (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_nios1_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (clocks_sys_clk_clk),                                //       clk.clk
		.reset              (nios2_processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_nios1_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
